...
{
    public class QprCRUDRepo : IQprCRUDRepo
    {
        public readonly ILogger<QprCRUDRepo> _logger;
        ...
        {//, adviceofcvcqrs prevData
            try
            {
                if (adviceVM.AdviceOfCvc != null)
                {
                    ...
                    adviceofcvcqrs prevData = await _qprRepo.GetAdviceOfCVCData(_httpContext.HttpContext?.Session.GetString("referenceNumber"));
        ...
        public async Task SaveStatusPendency(StatusOfPendencyViewModel statusVM)
        {
            try
            {
                if (statusVM.StatusOfPendency != null)
                {
                    ...
                    statusofpendencyqrs prevData = await _qprRepo.GetStatusPendencyData(_httpContext.HttpContext?.Session.GetString("referenceNumber"));
        ...
        public async Task SavePunitiveVigilance(punitivevigilanceqrs pVig)
        {
            try
            {
                if (pVig != null)
                {
                    punitivevigilanceqrs prevData = await _qprRepo.GetPunitiveVigilanceData(_httpContext.HttpContext?.Session.GetString("referenceNumber"));
        ...
        public async Task SavePreventiveVigilance(PreventiveVigilanceViewModel pVig)
        {
            try
            {
                preventivevigilanceqrs prevData = await _qprRepo.GetPreventiveVigilanceData(_httpContext.HttpContext?.Session.GetString("referenceNumber"));
        ...
        public async Task SavePreventiveVigilanceActivities(vigilanceactivitiescvcqrs vigilanceactivities)
        {
            try
            {
                vigilanceactivitiescvcqrs prevData = await _qprRepo.GetPreventiveVigilanceActivitiesData(_httpContext.HttpContext?.Session.GetString("referenceNumber"));
