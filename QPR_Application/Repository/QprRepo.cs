...
namespace QPR_Application.Repository
{
    public class QPRRepo : IQPRRepo
    {
        ...
        public QPRRepo(QPRContext dbContext, IHttpContextAccessor httpContext, IConfiguration iConfig)
        {
        ...
        public async Task<AdviceOfCvcViewModel> GetAdviceOfCVCViewModel(string refNum)
        {
            ...
            try
            {
                ...
                if (advice.AdviceOfCvc == null)
                {
                    advice.AdviceOfCvc = new adviceofcvcqrs();
                }
                else
                {
                    _httpContext.HttpContext?.Session.SetString("advice_cvc_id", Convert.ToString(advice.AdviceOfCvc.advice_cvc_id));
                }
